...
calculate these scagnostics. We started with the original defnitions of
the scagnostics but removed the pre-processing step of binning and found
that some measures did not work as expected. Redefinining the
scagnostics allowed us to implement versions that do not require binning
into the package. Through a series of examples, \emph{cassowaryr} is
shown to be useful as a step in exploratory data analysis, as a tool to
identify between group differences, and as a summary tool for the shape
of a data set.
}
...
=======
additional visual explanation in Figure @ref(fig:scagdrawn). We will let
>>>>>>> fd3c934a2667a70fc2e820af62a263f42909fa2c
...
While we mentioned some issues in the disributions of the scagnostics,
...
While the time series example shows that scagnostics can identify shape
