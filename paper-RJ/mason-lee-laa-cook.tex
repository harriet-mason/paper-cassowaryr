...
discrete, a very low value on striated\_adjusted would indicate some
strange relationship in the scatter plot. Since the old striated measure
...
\includegraphics{mason-lee-laa-cook_files/figure-latex/unnamed-chunk-6-1} \end{Schunk}
...
\includegraphics{mason-lee-laa-cook_files/figure-latex/unnamed-chunk-7-1} \end{Schunk}
...
The World Bank delivers a lot of
\href{https://databank.worldbank.org/source/world-development-indicators/preview/on\#}{development
indicators}, for many countries and multiple years. The sheer volume of
indicators, in addition to substantial missing values, makes a barrier
to analysis. This is a good example to where scagnostics can be used to
identify pairs of indicators with interesting relationships.
