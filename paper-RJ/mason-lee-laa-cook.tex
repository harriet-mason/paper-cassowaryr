...
\hypertarget{black-hole-merger-data-description}{%
\subsection{Black Hole Merger Data
Description}\label{black-hole-merger-data-description}}

its position in the sky (three variables: ra, dec, distance), the time
of the event (time), the black hole properties (masses m1 and m2; spin
