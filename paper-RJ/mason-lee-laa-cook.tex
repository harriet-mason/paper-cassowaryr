...
\begin{Schunk}
\begin{figure}
\includegraphics[width=1\linewidth]{mason-lee-laa-cook_files/figure-latex/Outlying test plot-1} \caption[Outlying Test Plots]{Outlying Test Plots}\label{fig:Outlying test plot}
\end{figure}
\end{Schunk}
