...
ball.\\
- \emph{totalPossessions}: The total number of disposals for a player.
Possessions and disposals are the same thing.\\
inside50s: the number of times the player has the ball within the 50m
...
\begin{Schunk}
\begin{figure}
\includegraphics{mason-lee-laa-cook_files/figure-latex/aflwstatic-1} \caption[Scatterplots with high values on the splines scagnostic]{Scatterplots with high values on the splines scagnostic.}(\#fig:aflwstatic)
\end{figure}
\end{Schunk}

Figure @(fig:aflwinteractive) shows three scatterplots that score highly
