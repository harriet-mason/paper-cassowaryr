...
datasets_tb <- tibble(dt = c("features", 
                      ...
                      text = c("Simulated data with special features. ",
                               "Data from Anscombes famous example in tidy format.", "Datasaurus Dozen data in a long tidy format."))
```
