...
# hitouts plot. this is a plot that will have a higher striated value with increasing data
# it only has a low value because there is not enough data to fill every possible value
ggplot(aflw, aes(x=dreamTeamPoints, y=hitouts)) + geom_point()
ggplot(aflw, aes(x=hitouts, y=disposals)) + geom_point()
