...
calcfunc_tb %>% kable(caption="The main arguments for the `calc_scags()` function.") 
```

```{r calcfunc_tb_pdf, eval=is_latex_output()}
calcfunc_tb %>% kable(format="latex", caption="The main arguments for the \verb#calc_scags()# function.") 
```
