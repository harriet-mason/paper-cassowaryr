...
```{r}
sumfuncs_tb <- tibble(funcname = c("calc\\_scags",
                             "calc_scags\\_wide"), 
...
sumfuncs_tb %>% kable(caption = "Cassowaryr Summary Functions", booktabs = T)  %>%
...
sumfuncs_tb %>% kable(format="latex", caption = "Cassowaryr Summary Functions", booktabs = T)  %>%
