...
pp1 <- ggplotly(p1, width=650, height=500)
pp2 <- ggplotly(p2, width=650, height=500)
pp3 <- ggplotly(p3, width=650, height=500)
pp4 <- ggplotly(p4, width=650, height=500)
pp5 <- ggplotly(p5, width=650, height=500)
pp6 <- ggplotly(p6, width=650, height=500)
...
#titles
p1 <- p1 + ggtitle("Plot 1")
p2 <- p2 + ggtitle("Plot 2")
p3 <- p3 + ggtitle("Plot 3")
p4 <- p4 + ggtitle("Plot 4")
p5 <- p5 + ggtitle("Plot 5")
p6 <- p6 + ggtitle("Plot 6")
