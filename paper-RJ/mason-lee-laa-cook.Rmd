...
```{r convexscag, out.height = "30%", out.width = "100%", fig.cap = "Convex Scagnostic Visual Explanation"}
...
```{r skinnyscag, out.height = "30%", out.width = "100%", fig.cap = "Skinny Scagnostic Visual Explanation"}
...
```{r outlyingscag, out.height = "30%", out.width = "100%", fig.cap = "Outlying Scagnostic Visual Explanation"}
...
```{r stringyscag, out.height = "30%", out.width = "100%", fig.cap = "Stringy Scagnostic Visual Explanation"}
...
```{r skewedscag, out.height = "30%", out.width = "100%", fig.cap = "Skewed Scagnostic Visual Explanation"}
...
```{r sparsescag, out.height = "30%", out.width = "100%", fig.cap = "Sparse Scagnostic Visual Explanation"}
...
```{r clumpyscag, out.height = "30%", out.width = "100%", fig.cap = "Clumpy Scagnostic Visual Explanation"}
...
```{r striatedscag, out.height = "30%", out.width = "100%", fig.cap = "Striated Scagnostic Visual Explanation"}
...
```{r monotonicscag, out.height = "30%", out.width = "100%", fig.cap = "Monotonic Scagnostic Visual Explanation"}
...
```{r splinescag, out.height = "30%", out.width = "100%", fig.cap = "Splines Scagnostic Visual Explanation"}
...
```{r dcorscag, out.height = "30%", out.width = "100%", fig.cap = "Dcor Scagnostic Visual Explanation"}
...
The scagnsotics need to be used and interpreted with the type of dataset you are working with in mind. For  if we are looking at a dataset that is discrete, a very low value on striated_adjusted would indicate some strange relationship in the scatter plot. Since the old striated measure is specifically trying to find a continuous variable against a discrete variable, its highest values are also identified by the striated_adjusted. The lowest values on striated simply identify a plot where all the variables are at right angles, once again a measure of disceteness but one that is not identified by striated. Striated_adjusted encapsulates both versions of discreteness in the values that get exactly a 1.
...
```{r, AFLW Scatter Plots , echo=FALSE, out.width = "80%"}
load("paper-RJ/data/aflw.rda")
load("paper-RJ/data/aflw_num.rda")
load("paper-RJ/data/AFLW_scags.rda")
...
```{r AFLW-scatters-static, out.width="80%", include=knitr::is_latex_output(), eval=knitr::is_latex_output()}
...
```{r, 3 Random Plots, echo=FALSE, out.width = "80%"}
...
```{r, plot1-interactive, out.width="50%", include=knitr::is_html_output(), eval=knitr::is_html_output()}
...
```{r plot1-static, out.width="50%", include=knitr::is_latex_output(), eval=knitr::is_latex_output()}
...
```{r, plot2-interactive, out.width="50%", include=knitr::is_html_output(), eval=knitr::is_html_output()}
...
```{r plot2-static, out.width="50%", include=knitr::is_latex_output(), eval=knitr::is_latex_output()}
...
```{r, plot5-interactive, out.width="50%", include=knitr::is_html_output(), eval=knitr::is_html_output()}
...
```{r plot5-static, out.width="50%", include=knitr::is_latex_output(), eval=knitr::is_latex_output()}
