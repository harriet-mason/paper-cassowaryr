...
calcfunc_tb %>% kable(format="latex", caption="The main arguments for calc\\_scags().", escape=FALSE) 
```
...
features_scags %>% kable(format="latex", caption = "Summary of three scagnostics computed by calc\\_scags() on the long form of the features data.", escape=FALSE) 
```
