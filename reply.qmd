...
**I agree, although it was less of an issue when we originally wrote the paper (four years ago). The title has been changed.**
...
- stringy description on page 4: would benefit from explicitly stating the vertices are from the MST, all other descriptions are explicit about using the MST, A, or C
**We agree and have made the changes.**
...
**Check if lines should be vline or line or both? We agree. To make it clear we have changed the sentence to: ____**
...
**I think I specifically tried to use the terminology from the original scagnostics paper to keep it consistent. Check that. But also, if the reviewer was confused, we should probably reword this so it is clearer. **
